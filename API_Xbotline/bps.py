...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ BPS_game.json
    with open('BPS_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_BPS.json', 'w', encoding='utf-8') as json_file:
