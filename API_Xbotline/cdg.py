...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ CDG_casino.json
    with open('CDG_casino.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
        ...
        "contents": [
          {
            ...
            "contents": [
              {
                "type": "image",
                "url": "https://img5.pic.in.th/file/secure-sv1/DGM_1622783833.webp",
                "align": "start",
                "size": "xs"
              },
              {
    ...
    with open('flex_message/BONUSTIME_CDG.json', 'w', encoding='utf-8') as json_file:
