...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ GDY_game.json
    with open('GDY_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_GDY.json', 'w', encoding='utf-8') as json_file:
