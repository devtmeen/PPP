...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ SBOS_game.json
    with open('SBOS_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_SBOS.json', 'w', encoding='utf-8') as json_file:
