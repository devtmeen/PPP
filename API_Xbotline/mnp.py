...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ MNP_game.json
    with open('MNP_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_MNP.json', 'w', encoding='utf-8') as json_file:
