...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ EXPS_game.json
    with open('EXPS_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_EXPS.json', 'w', encoding='utf-8') as json_file:
