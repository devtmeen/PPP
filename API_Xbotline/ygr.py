...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ YGR_game.json
    with open('YGR_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_YGR.json', 'w', encoding='utf-8') as json_file:
