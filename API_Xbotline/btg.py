...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ BTG_game.json
    with open('BTG_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_BTG.json', 'w', encoding='utf-8') as json_file:
