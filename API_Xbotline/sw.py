...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ SW_game.json
    with open('SW_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_SW.json', 'w', encoding='utf-8') as json_file:
