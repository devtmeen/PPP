...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ ADP_game.json
    with open('ADP_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_ADP.json', 'w', encoding='utf-8') as json_file:
