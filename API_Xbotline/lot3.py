...
def job():
  ...
  "hero": {
    "type": "image",
    "url": "https://medias.thansettakij.com/uploads/images/md/2024/01/VchzHh6H8LXO8j7mLZRq.webp",
    "size": "full",
    "aspectRatio": "9:4",
    "aspectMode": "cover"
  },
  "body": {
    ...
    with open('flex_message/หวยรัฐบาล.json', 'w', encoding='utf-8') as json_file:
