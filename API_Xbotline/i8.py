...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ I8_game.json
    with open('I8_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_I8.json', 'w', encoding='utf-8') as json_file:
