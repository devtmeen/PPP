...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ ODG_game.json
    with open('ODG_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_ODG.json', 'w', encoding='utf-8') as json_file:
