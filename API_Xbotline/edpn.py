...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ EDPN_game.json
    with open('EDPN_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_EDPN.json', 'w', encoding='utf-8') as json_file:
