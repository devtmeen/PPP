...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ G5_game.json
    with open('G5_Game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_G5.json', 'w', encoding='utf-8') as json_file:
