...
def job():
    ...
    # อ่านข้อมูลจากไฟล์ WMS_game.json
    with open('WMS_game.json', 'r', encoding='utf-8') as json_file:
  ...
  "contents": [
    ...
    with open('flex_message/BONUSTIME_WMS.json', 'w', encoding='utf-8') as json_file:
