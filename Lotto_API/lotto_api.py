...
def check_update2():
    ...
    "authorization": "Bearer teague268",
    ...
    url = "https://manager.expalert.com/publish/lotto/api"
    ...
    '''
    if response.status_code == 200:
        with open(f"หวยหุ้น.json", "r", encoding="utf-8") as jsonFile:
            DB = json.load(jsonFile)

        DB['contents'][0]['body']['contents'][0]['contents'][0]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][0]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][1]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][1]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][2]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][2]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][3]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][3]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][4]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][4]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][5]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][5]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][6]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][6]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][7]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][0]['body']['contents'][0]['contents'][7]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"

        DB['contents'][1]['body']['contents'][0]['contents'][0]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][0]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][1]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][1]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][2]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][2]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][3]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][3]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][4]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][4]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][5]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][5]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][6]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][6]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][7]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "xx"
        DB['contents'][1]['body']['contents'][0]['contents'][7]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "xx"


        data = response.json()
        for item in data["response"]:
            if item["lottosName"] == "nikkei-visa-morning":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][0]['body']['contents'][0]['contents'][0]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][0]['body']['contents'][0]['contents'][0]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "nikkei-visa-afternoon":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][0]['body']['contents'][0]['contents'][1]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][0]['body']['contents'][0]['contents'][1]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "set":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][0]['body']['contents'][0]['contents'][2]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][0]['body']['contents'][0]['contents'][2]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "szse-morning":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][0]['body']['contents'][0]['contents'][3]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][0]['body']['contents'][0]['contents'][3]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "szse-afternoon":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][0]['body']['contents'][0]['contents'][4]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][0]['body']['contents'][0]['contents'][4]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "hsi-morning":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][0]['body']['contents'][0]['contents'][5]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][0]['body']['contents'][0]['contents'][5]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "hsi-afternoon":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][0]['body']['contents'][0]['contents'][6]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][0]['body']['contents'][0]['contents'][6]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "twse":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][0]['body']['contents'][0]['contents'][7]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][0]['body']['contents'][0]['contents'][7]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]


            if item["lottosName"] == "ktop30":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][1]['body']['contents'][0]['contents'][0]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][1]['body']['contents'][0]['contents'][0]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "sgx":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][1]['body']['contents'][0]['contents'][1]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][1]['body']['contents'][0]['contents'][1]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "bsesn":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][1]['body']['contents'][0]['contents'][2]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][1]['body']['contents'][0]['contents'][2]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "germany-vip":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][1]['body']['contents'][0]['contents'][4]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][1]['body']['contents'][0]['contents'][4]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "moexbc":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][1]['body']['contents'][0]['contents'][5]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][1]['body']['contents'][0]['contents'][5]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "ftse100":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][1]['body']['contents'][0]['contents'][6]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                    DB['contents'][1]['body']['contents'][0]['contents'][6]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]
            if item["lottosName"] == "xxxxxxxxxxxxxxxxxxxxxx":
                    print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                    if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                            item["lottosNumber"] = item["lottosNumber"][-3:]
                    DB['contents'][1]['body']['contents'][0]['contents'][7]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = "31"
                    DB['contents'][1]['body']['contents'][0]['contents'][7]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = "32"
            if item["lottosName"] == "dowjone-special":
                print(item["lottosTH"] + " " + item["lottosNumber"][-3:] + " " + item["lottosUnder"])
                if (count_numbers_in_string(item["lottosNumber"]) >= 3):
                        item["lottosNumber"] = item["lottosNumber"][-3:]
                DB['contents'][1]['body']['contents'][0]['contents'][7]['contents'][1]['contents'][1]['contents'][0]['contents'][1]["text"] = item["lottosNumber"]
                DB['contents'][1]['body']['contents'][0]['contents'][7]['contents'][1]['contents'][1]['contents'][1]['contents'][1]["text"] = item["lottosUnder"]

    with open(f"หวยหุ้น.json", 'w', encoding='utf-8') as json_file:
            json.dump(DB, json_file, ensure_ascii=False, indent=4)
